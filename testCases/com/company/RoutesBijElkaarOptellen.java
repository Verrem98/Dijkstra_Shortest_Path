...
class RoutesBijElkaarOptellen {
    ...
    void shortestPath() {
        ...
        Reis reis_1 = new Reis(plaatsen,utrecht,brussel,treinrit);
        Reis reis_2 = new Reis(plaatsen,utrecht,amsterdam,treinrit);
        Reis reis_3 = new Reis(plaatsen,amsterdam,brussel,treinrit);
